...
$fields = array();
$fields[] = array('name' => 'check-in',		'display_name' => 'Check-in',          		'type' => 'text',        'required' => true);
$fields[] = array('name' => 'check-out',	'display_name' => 'Check-out',         		'type' => 'text',        'required' => true);
$fields[] = array('name' => 'people',		'display_name' => 'People',            		'type' => 'text',        'required' => true);
$fields[] = array('name' => 'rooms',		'display_name' => 'Rooms',             		'type' => 'text',        'required' => true);
...
$fields[] = array('name' => 'business',		'display_name' => 'Travel for business',	'type' => 'radio',       'required' => true);
